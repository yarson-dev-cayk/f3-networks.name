...
endwhile;
?>
<main id="f3_externalnews" class="f3-home f3-home-page f3-externalnews-page">

    <?php get_template_part('page-templates/components/__header_menu');?> <!--OFFCANVAS SIDE MENU-->

    <div class="f3-zone f3-zone--dark">
        <?php get_template_part('page-templates/components/news/f3_hero');?> <!--S1:HERO-->
    </div><!--/f3-zone--dark-->
    ...
    <div class="f3-zone f3-zone--dark2">
        <?php get_template_part('page-templates/components/news/f3_externalnews');?> <!--S2:CAREERINFO--> 
    </div><!-- /f3-zone--light -->

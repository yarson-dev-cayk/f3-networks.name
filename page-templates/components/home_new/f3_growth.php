    ...
    <div class="container-lg">
        <div class="row f3-supporting__header">
            <div class="col-12 col-md-6">
                <?php if($growth_title = get_field('growth_title')):?><h2 class="f3-section__heading" data-aos="fade-right"><?php echo $growth_title;?></h2><?php endif;?>
                <?php if($growth_subtitle = get_field('growth_subtitle')):?><p class="f3-section__text" data-aos="fade-up"><?php echo $growth_subtitle;?></p><?php endif;?>
            </div>
        </div>
